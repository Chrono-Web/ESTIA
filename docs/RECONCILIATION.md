...
| E2E (DM, poi gruppi)              | **DM costruiti in M6** con `ESTIA-E2E-v1`, non con MLS ([ADR 0036](adr/0036-estia-e2e-v1-e-il-debito-verso-mls.md)). I **gruppi** restano Successive #5 e restano legati a MLS |
