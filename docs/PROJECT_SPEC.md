...
- relay per attraversare NAT **quando non esiste un percorso diretto**, che si tenta sempre per primo: inoltrano dati cifrati fra i due capi, che non possono leggere né conservare, e devono essere molti e ospitabili da chiunque, mai il servizio di un unico fornitore ([ADR 0018](adr/0018-federazione-fra-istanze-estia.md));
