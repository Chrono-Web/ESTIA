...
**L'eccezione, delimitata il 2026-08-20**: a un'istanza **collegata** si può elencare **i profili di chi ha scelto «presente e pubblico»**, e nient'altro. Non è una crepa nella regola, è la regola applicata bene — quelle persone hanno chiesto esplicitamente di essere trovabili, e un elenco che le contiene fa la cosa che hanno chiesto. Restano non elencabili **per sempre e per chiunque**: i membri che non sono presenti nella rete, i profili presenti-e-privati, i post, e le connessioni di questa istanza.

Va scritto anche come si è arrivati qui, perché la prima versione di questo paragrafo diceva un'altra cosa. Sosteneva che questa regola e la scoperta di [ADR 0018](0018-federazione-fra-istanze-estia.md) «si sostengono». **Non era vero**: quel documento chiedeva a ogni istanza di conservare i profili pubblici delle istanze collegate, e per farlo serviva esattamente la domanda che questa riga vieta. Le due si sono scontrate, non sostenute. Sciolto il nodo togliendo l'indice da ADR 0018 e delimitando l'eccezione qui: adesso l'unica cosa elencabile è l'insieme di chi ha chiesto di esserlo, e nessuna istanza conserva quell'elenco.

**Un profilo nominato si può chiedere anche se è privato**, ed è ciò che rende possibile il contatto diretto per QR code: «presente e privato» significa non comparire nelle ricerche, non essere irraggiungibile da chi ha già il nome. Ma con un vincolo che vale come proprietà di sicurezza: **«non trovato» deve essere indistinguibile da «non esiste».** Rispondere «esiste ma non è presente» ricostruirebbe l'enumerazione una domanda per volta, che è il modo in cui queste cose vengono aggirate davvero.
