...
| Rete fra istanze | **Aperta dal 2026-08-20**, in deroga dichiarata alla regola di avanzamento (vedi M3). Dei quattro cancelli di [ADR 0018](adr/0018-federazione-fra-istanze-estia.md): 1 chiusa, 3 e 4 da fare, 2 rinviata con motivazione. Il protocollo resta dietro la 4 |
| Interfaccia      | **Rifatta per intero dal 2026-08-21**, in sette consegne, su richiesta del proprietario. Nessuna milestone nuova: è la stessa funzionalità in una forma diversa, e la voce sta sotto il punto 1 delle milestone successive                                |
...
**Il punto 2 fa eccezione dal 2026-08-20**, ed è dichiarata in M3: la rete fra istanze è aperta, e il «nuovo piano tecnico» che questa riga pretende sono le quattro verifiche di [ADR 0018](adr/0018-federazione-fra-istanze-estia.md) — di cui una è chiusa, una rinviata con motivazione scritta, e due ancora da fare. I punti 1 e 7, che sono profili e ricerca di profili, **restano dietro** quelle due: senza rete non c'è niente da cercare, e senza il capitolo di sicurezza non si sa che cosa un'istanza sconosciuta possa chiedere.
...
1. **Profilo, con follow e richieste di follow.** **Costruito il 2026-08-20**; lo scope `followers` sui contenuti è arrivato il **2026-08-21** e vale per i follower **di questa istanza**, mentre la consegna a quelli remoti resta aperta ed è materia di [ADR 0023](adr/0023-come-si-legge-la-bacheca-di-una-persona-di-un-altra-istanza.md), che è una bozza e non una decisione. Il profilo ha una presenza scelta dalla persona ed è servibile in rete; il follow attraversa le istanze con [ADR 0022](adr/0022-il-follow-attraversa-le-istanze.md). Pagina profilo, profilo chiuso o aperto, e lo scope `followers` — che è nello schema dalla prima migrazione del feed e non è mai stato implementato. Comprende la scelta della cerchia al momento di pubblicare, che oggi l'interfaccia non offre di proposito: un post «pubblico» non raggiungerebbe nessuno finché non c'è federazione, e un'etichetta che mente è peggio di una funzione che manca.
   ...
   - **L'interfaccia è stata rifatta per intero il 2026-08-21**, su richiesta del proprietario e in sette consegne. Non è una milestone nuova: la funzionalità è la stessa, cambia la forma — che era quella del backend e non quella di un social network. Quello che è entrato, e il difetto che ciascuna cosa chiude:
