...
- [ ] Installazione guidata e diagnostica.
  ...
  - [ ] Diagnostica nell'interfaccia, oltre alla tabella dei sintomi. La sezione «Stato dell'istanza» esiste e finora dice due cose: la cifratura a riposo osservata contro quella dichiarata, e **l'ultimo aggiornamento dello schema con il suo backup** (ADR 0014). Mancano il resto — a partire dallo stato dei backup periodici, che l'istanza sa già leggere e non mostra a nessuno.
