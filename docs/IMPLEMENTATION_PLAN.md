...
- Ne discende la conseguenza registrata in ADR 0018 il giorno stesso: **la scoperta passa alla DHT di BitTorrent** e i relay devono essere **molti, sostituibili e ospitabili da chiunque**. Non è più una verifica da fare ma una condizione di adozione, perché con un relay unico e di un'azienda la promessa di [`PRODUCT_VISION.md`](PRODUCT_VISION.md) §11 — «una rete che nessuno può spegnere con una decisione aziendale» — sarebbe falsa. **Stato dei quattro cancelli al 2026-08-20**, riordinati in ADR 0018 §«Prima di implementare» — riordinati per iscritto, non rinumerati in silenzio:

| #   | Verifica                                           | Stato                                                                                                                                                                                                                        |
| --- | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | iroh su un NAS ARM vero                            | **Chiusa** il 2026-08-20, `arm64` + `x86_64` in due case                                                                                                                                                                     |
| 3   | Scoperta e relay senza infrastruttura obbligatoria | **Ridotta a una prova sola**: i relay di n0 sono accettati come ripiego dichiarato, e l'autoospitato è escluso perché vuole una porta aperta sul router. Resta da provare che **due case si raggiungano con la sola chiave** |
| 4   | Capitolo di sicurezza per le istanze sconosciute   | **Aperta, ed è la sola che resta davvero davanti al protocollo**: l'assunzione di [`SECURITY_BASELINE.md`](SECURITY_BASELINE.md) §5 cambia proprio qui                                                                       |
