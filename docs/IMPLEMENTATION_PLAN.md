...
| M4         | **Aperta nella prima voce** — trasporto del pilot dichiarato e documentato; la scelta del trasporto non è iniziata                        |
...
- [~] Backup **automatico** cifrato con chiave distinta conservata fuori dall'istanza, comprensivo della chiave privata dell'istanza, e restore provato. Costruito tutto, compresa la gestione dal pannello; manca la sola prova di ripristino su hardware vero:
  ...
  - [~] La prova di un ripristino sul **NAS reale**. Costruito e provato altrove: round trip completo, archivio manomesso rifiutato, riapertura con `age` 1.2.1 e GNU tar, e dal 2026-08-17 backup e download dal pannello senza terminale. Manca: **ripristinare un archivio vero su quel NAS e vedere l'istanza tornare**. Chiude anche il criterio 4 del gate M1.
...
1. **un ripristino da backup cifrato su un NAS reale** — mai eseguito su hardware, solo in container;
