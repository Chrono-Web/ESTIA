...
**Le app si riaprono come programma proprio, dopo ESTIA 1.0**, per iOS e Android insieme e con un piano scritto da zero. Le tre precondizioni sono nella lapide di M7: lo spike React Native su MLS, la decisione sulle notifiche push, e l'ADR di M4 sul trasporto definitivo. Nessuna è fatta. **Dal 2026-09-23 il percorso intero, in ordine, è nel piano, §«Prima delle app»**, e aggiunge quello che la lapide non diceva: il multi-dispositivo come precondizione più importante, la compatibilità fra versioni, distribuzione e licenza. Lì i due spike — React Native su MLS e il motore di rete su mobile — possono partire in parallelo, come ogni spike; le decisioni si preparano e ci si ferma; il codice delle app no.
...
**Aggiornamento del 2026-09-07.** Il proprietario ha accettato **ADR 0043**, precisando anche l'eccezione ammessa. Matteo su B scrive a Marco su A: **A conserva solo il segnaposto con mittente, orario e riferimenti necessari; il contenuto resta su B e viene sempre richiesto a B**. Nessun testo, allegato, anteprima, citazione copiata, busta o archivio cifrato nel deposito remoto. Il segnaposto è vuoto rispetto al contenuto: non è il nome nuovo di una busta cifrata. Può restare nei backup e quando B non risponde; il contenuto no. I byte transitano in memoria durante la visita, senza cache persistenti.

**0042 è stata aggiornata e resta Proposed** per ordinamento, registri remoti e stato condiviso. La scelta di custodia non approva automaticamente questi altri confini di fiducia. Prima del taglio servono protocollo dei segnaposto, visite autorizzate, provenienza delle voci, invalidazione della vista e migrazione delle copie esistenti, compresi WAL e backup. Non dichiarare attivo il divieto: la chat attuale conserva ancora buste remote. **Il gate M6 sul NAS resta aperto.**
