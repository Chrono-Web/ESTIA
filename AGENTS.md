...
**Aggiornato il 2026-08-27. Leggi prima l'ultimo aggiornamento in fondo a questa sezione: è quello che vale.** M0, M1, M2, M3 e M5 sono complete con i gate chiusi; M6 è costruita e il suo gate è **mezzo passato** — la conversazione fra due case è avvenuta il 2026-08-27, resta l'ispezione di database e backup; M7 è **ritirata**; M8 (i gruppi) è aperta e bloccata da [ADR 0039](docs/adr/0039-mls-attraversa-le-istanze.md).
